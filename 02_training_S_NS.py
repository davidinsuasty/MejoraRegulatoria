...
param_grid = {
    ...
    'SVM': [ {'C': [.001, .01, .1, .5, 1., 2.], 'kernel':['linear']},
             {'C': [.001, .01, .1, .5, 1., 2., 3.], 'kernel':['poly'], 'degree':[2, 3,4,5,6]},
             {'C': [.8, 1., 1.2, 1.5], 'kernel':['rbf'], 'gamma':['auto','scale',1e-3, 1e-2, 1e-1, 1, 2, 2.5,2.8, 3, 3.2,]}
        ],
    'MNB': {'alpha':[0.5, 1.] 
        },
    'MLR': {'C':[float(x) for x in np.linspace(start = 0.1, stop = 2, num = 5)],
            'solver': ['newton-cg', 'sag', 'saga', 'lbfgs'],
            'class_weight': ['balanced', None],
            'penalty': ['l2', 'elasticnet']
        },
    'GB': {'max_depth': [10, 15, 20, 30, 50],
           'max_features': ['auto', 'sqrt'],
           'min_samples_leaf': [1, 2, 4],
